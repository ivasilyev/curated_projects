...
class PivotTableAnnotator:
    ...
    def export_group_reports(self, output_dir, multi_test="fdr_bh", single_test="u-test", base_col_name="reference_id", annotation_col_name="pfasta_header"):
        ...
        for bool_col_name in bool_col_names_list:
            ...
            if len(comparison_df) > 0:
                ...
                for base_id in comparison_df.index.tolist():
                    ...
                    def draw_boxplot(left_list, right_list, left_name, right_name, title, output_file):
                        ...
                        plt.close()
                    draw_boxplot(left_list=left_group_pivot_df.loc[base_id].values.tolist(),
