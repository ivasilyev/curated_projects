...
echo Remove taxonomy descriptions from FASTA headers, and convert the sequences from RNA to DNA for both the aligned FASTA
python ${SDIR}convert_rna_to_dna.py -g \
  -i SILVA_138_SSURef_NR99_tax_silva_full_align_trunc.fasta \
  -o SILVA_align_seqs.fasta

echo Remove sequences that contain 5 or more ambiguous bases and/or homopolymers with 8 or more bases
